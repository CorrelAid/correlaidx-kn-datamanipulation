...
**Exercise time:** Thanks to the World Bank, the data is again in wide format (oh no!). Fix this using `pivot_longer()`!
...
```{r}
left_join(fert_long, educ |> distinct(), by = c("CountryCode", "year"))
```
